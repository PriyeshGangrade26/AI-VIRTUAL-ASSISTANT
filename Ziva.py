...
def screenshot():
    try:
        ...
        myScreenshot.save('D:\\Ziva\\Ziva_Screenshot_Data\\1.png')
    except Exception as e:
        print("An unknown error has been occurred, Try Again...")
def weather_info():
    try:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            print("\n")
            exit()
        elif 'email to priyesh' in query:
            try:
                print("What Should I Say?")
                content = takeCommand()
                to = "priyeshgangrade786@gmail.com"
            ...
            print("I was Designed or Created by Priyesh.")
            ...
            print("My Owner Name is Priyesh Gangrade, And He is a Software Developer.")
            ...
            weather_info()
        elif 'where is' in query or 'ziva where is' in query:
            query = query.replace("where is ","")
            query = query.replace("ziva where is ","")
            location = query
